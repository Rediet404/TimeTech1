       ...
       <div className="flex max-sm:flex-wrap-reverse pt-4 sm:pt-0 justify-around h-1/4 items-center w-[90%] mx-auto">
        ...
        <div className="flex flex-col gap-10 w-screen bg-[#f8f8f8] py-12 mt-10">
          <div className="text-center">
            <p className=" text-xs uppercase">{t('service.service')}</p>
            <p className="font-semibold text-2xl">{t('service.what_we_do')}</p>
            ...
            <div className="px-6 pt-4">
              ...
              <div className="text-xs font-medium my-6 ml-4">
                ...
                {isDescriptionVisible[0] && (
                  <p>{t('service.services_data1_description2')}</p>
                )}
              </div>
            ...
            <div className="px-6 pt-4">
              ...
              <div className="text-xs  font-medium my-6 ml-4">
                ...
                {isDescriptionVisible[1] && (
                  <p>{t('service.services_data2_description2')}</p>
                )}
              </div>
              <div className="flex justify-center">
                <button
            ...
            <div className="px-6 pt-4">
              ...
              <div className="text-xs  font-medium my-3 ml-4">
                ...
                {isDescriptionVisible[2] && (
                  <p>{t('service.services_data3_description2')}</p>
                )}
              </div>
              <div className="flex justify-center">
                <button
            ...
            <div className="px-6 pt-4">
              ...
              <div className="text-xs  font-medium my-6 ml-4">
                ...
                {isDescriptionVisible[3] && (
                  <p>{t('service.services_data4_description2')}</p>
                )}
              </div>
              <div className="flex justify-center">
                <button
            ...
            <div className="px-6 pt-4">
              ...
              <div className="text-xs  font-medium my-6 ml-4">
                ...
                {isDescriptionVisible[4] && (
                  <p>{t('service.services_data5_description2')}</p>
                )}
              </div>
              <div className="flex justify-center">
                <button
            ...
            <div className="px-6 pt-4">
              ...
              <div className="text-xs  font-medium my-3 ml-4">
                ...
                {isDescriptionVisible[5] && (
                  <p>{t('service.services_data6_description2')}</p>
                )}
              </div>
              <div className="flex justify-center">
                <button
        ...
        <div className="text-center py-14">
          <h1 className="font-semibold sm:text-3xl text-2xl py-4">{t('service.sectors.header')}</h1>
          <p>{t('service.sectors.description')}</p>
        </div>
        <div className="flex justify-evenly flex-wrap gap-4">
        <button className="border-2 border-gray-50 w-72 rounded-lg h-12 flex gap-6 px-4 items-center">
          ...
          {t('service.sectors.sector1')}</button>
        <button className="border-2 border-gray-50 w-72 rounded-lg h-12 flex gap-6 px-4 items-center">
          ...
          {t('service.sectors.sector2')}</button>
        <button className="border-2 border-gray-50 w-72 rounded-lg h-12 flex gap-6 px-4 items-center">
          <svg width="30" height="30" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {t('service.sectors.sector3')}</button>
