...
const About = () => {
  return (
    ...
    <div className="w-80 h-36 relative mt-48  bg-white bg-opacity-100 z-20  flex  max-w-sm rounded-xl overflow-hidden shadow-lg">
          ...
          <div className="relative sm:mt-48 mt-4 bg-white bg-opacity-100 z-20  w-80 h-36 flex  max-w-sm rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="py-5">
              <div className="font-medium text-xl mb-2 ">Credibility</div>
              <p className="text-base pt-4 ">
              We deliver on our promise, <br /> every time with our guarantee.  
              </p>
            </div>
          </div>
          <div className="relative sm:mt-48 mt-4 bg-white bg-opacity-100 z-20  w-80 h-36 flex  max-w-sm rounded-xl overflow-hidden shadow-lg">
            ...
            <div className=" py-5">
              <div className="font-medium text-xl mb-2">Curiosity</div>
              <p className="text-base pt-4">
    ...
    <div className=" flex my-14 gap-5 flex-wrap-reverse mx-4 justify-evenly">
      ...
      <img  className="sm:h-60 h-0" src="src\assets\Lettering.png" alt="decorative image" />
      <div className="h-60 justify-center flex flex-col">
        <h1 className="font-semibold py-2 text-lg">Who We are: </h1>
        <p>We are a team of problem solvers and doers who is <br />
          dedicated to identify problems and gaps in business and <br />
          support them in technology affordable digital solutions at <br />
          an uncompromised level of quality.</p>
      </div>      
    <img className="h-60" src="/src/assets/Ai.png" alt="decorative image" />
    <div className="h-60 justify-center flex flex-col">
        <h1 className="font-semibold py-2 text-lg">Our Commitment </h1>
        <p>Since our inception, TIME SOFTWARE has <br /> 
          successfully delivered an impressive array of <br />
          successful projects for a long list of clients <br />
          across Educational, nd Other digital solution. 
          </p>
      </div>      
    <img className="h-60 w-72" src="/src/assets/space.png" alt="decorative image" />
    <div className="h-60  justify-center flex flex-col">
        <h1 className="font-semibold py-2 text-lg">Our Vision </h1>
        <p>TIMESOFTWARE aims to be one of the top web,<br />
           mobile, and custom software solution providers, <br />
           offering the best user experience.
           </p>
      </div>
      </div>
      <div className="hidden sm:flex flex-col justify-evenly  ">
      <svg width="33" height="200" viewBox="0 0 33 511" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M-0.000262418 396.461L29.0749 340.191L-0.000259389 283.87L29.0749 227.549L-0.00025636 171.279L29.0749 114.957L-0.00025333 58.6871L29.9762 0.688476L32.1277 4.09418L3.92489 58.6871L33 114.957L3.92489 171.279L33 227.549L3.92488 283.87L33 340.191L3.92488 396.461L33 452.732L3.05262 510.73L0.871988 507.325L29.0748 452.732L-0.000262418 396.461Z" fill="#5D328F" fillOpacity="0.2"/>
      </svg>
      <svg width="33" height="200" viewBox="0 0 33 511" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M-0.000262418 396.461L29.0749 340.191L-0.000259389 283.87L29.0749 227.549L-0.00025636 171.279L29.0749 114.957L-0.00025333 58.6871L29.9762 0.688476L32.1277 4.09418L3.92489 58.6871L33 114.957L3.92489 171.279L33 227.549L3.92488 283.87L33 340.191L3.92488 396.461L33 452.732L3.05262 510.73L0.871988 507.325L29.0748 452.732L-0.000262418 396.461Z" fill="#5D328F" fillOpacity="0.2"/>
      </svg>
      ...
      <div className="h-60">
        ...
        <h1 className="font-medium text-5xl">Your Trusted <br />
        Partner In <br /> Technology</h1>
      </div>
      <img className="h-60" src="/src/assets/Planet.png" alt="decorative image" />
      <div className="h-60 justify-center flex flex-col">
        <h1 className="font-semibold py-2 text-lg">Evolution Into Success </h1>
        <p>Founded in 2021, TIME SOFTWARE is a ETHIO- <br />
          headquartered provider of technology and marketing <br />
          solutions with professionals located in Ethiopia. We <br />
          leverage both local in international talent via our <br />
          offshore service delivery centers to deliver digital <br />
          transformational products and services to our clients..</p>
      </div>
      <img className="h-64" src="/src/assets/unlocked.png" alt="decorative image" />
      <div className="h-60 justify-center flex flex-col">
        <h1 className="font-semibold py-2 text-lg">Our Mission </h1>
        <p>We are committed to engineering world-class digital <br />
          solutions, products, and services that would solve <br />
          business problems to improve efficiency.
          </p>
      </div>
      <img className="h-52 w-72" src="/src/assets/lace.png" alt="decorative image" />
  ...
  <div className="w-9/12">
    <p className="text-start flex-wrap">
      Our diverse services encompass IT services, software solutions, 
      website and application development, consultancy, and ERP software 
      development. Backed by an elite team with extensive experience serving 
      both enterprises and startups, we take pride in being your tech partner 
      on the path to business success, market dominance, and unwavering dependability. 
