...
const Footer = () => {
  return (
    ...
    <div className="font-inter bg-black flex flex-wrap  pt-8 items-start justify-around mt-24">
    <div className=" text-white w-72 rounded-xl p-2 mb-4 " style={{background: "#776DF2"}}>
        ...
        <p className="text-xs p-2 font-medium">Time Software is managed services provider (MSP) or a 
             Full-Stack IT solutions company that provides end-to-end 
            technology services for businesses across industries.</p>
